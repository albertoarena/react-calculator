...
export default class Modal extends React.Component {
  ...
  render() {
    ...
    const className = ["component-modal", this.props.css || ""];

    const footerClassName = ["component-modal-footer", this._footerCss()];
    ...
    return (
      <div className={rootClassName.join(" ").trim()}>
        ...
        <div className="component-modal-wrap">
          ...
          >
            {this._headerClose()}
            <div className="component-modal-header">{this.props.header}</div>
            <div className="component-modal-body">{this.props.body}</div>
